...
Lemma basic_bridge_agree j S1 P m1 t1 Γ pc k ev j1 S1f P1f m1f t1f Γ1 pc1 S2 m2 t2 k' ev' j2 S2f P2f m2f t2f Γ2 pc2:
  agree_on_public Γ m1 m2 ->
  (⟦ t1 ⟧p) = (⟦ t2 ⟧p) ->
  basic_bridge (Some j , S1 , P , m1 , t1) Γ pc
    k ev
    (j1, S1f, P1f, m1f, t1f ) Γ1 pc1 ->
  basic_bridge (Some j, S2, P, m2, t2 ) Γ pc
    k' ev'
    (j2, S2f, P2f, m2f, t2f ) Γ2 pc2 ->
  ev = ev'
  /\ j1 = j2 /\ P1f = P2f /\ Γ1 = Γ2 /\ pc1 = pc2
  /\ agree_on_public Γ1 m1f m2f /\ (⟦ t1f ⟧p) = (⟦ t2f ⟧p).
Proof.
Admitted.
(*
   intros Hm Ht Hbr1 Hbr2.
