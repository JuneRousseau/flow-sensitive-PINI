...
Section~\ref{subsec:opsem} the I/O \whilelang language, and its operational semantic.
...
Section~\ref{subsec:type_system}.
...
\end{align*}
The intuition is that, if the adversary has already discover the public trace $\delta$ during the
...
transitions emitting a public event.
